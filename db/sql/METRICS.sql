...
INSERT INTO METRICS(height, weight, nationality,place_of_birth,userId,education)
VALUES (1.73, 87, "French","Lyon",15,"Master's Degree");

INSERT INTO METRICS(height, weight, nationality,place_of_birth,userId,education)
VALUES (1.74, 84, "U.S.A","New York",16,"High School Diploma");

INSERT INTO METRICS(height, weight, nationality,place_of_birth,userId,education)
VALUES (1.84, 97, "U.S.A","Texas",17,"Professional Degree");

INSERT INTO METRICS(height, weight, nationality,place_of_birth,userId,education)
VALUES (1.78, 87, "U.S.A","Liverpool",18,"No High School Diploma");

INSERT INTO METRICS(height, weight, nationality,place_of_birth,userId,education)
VALUES (1.97, 97, "GREEK","London",19,"Master's Degree");

INSERT INTO METRICS(height, weight, nationality,place_of_birth,userId,education)
VALUES (1.86, 60, "Italian","Milan",20,"Professional Degree");
COMMIT;